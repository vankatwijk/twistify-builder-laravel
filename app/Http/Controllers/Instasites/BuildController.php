...
class BuildController extends Controller
{
  ...
  private function validatePayload(array $in){
      return \Illuminate\Support\Facades\Validator::make($in, [
          ...
          'blueprint.theme.popup' => 'nullable|array',
          'blueprint.theme.popup.enabled' => 'nullable',
          'blueprint.theme.popup.imageUrl' => 'nullable|string|url',
          'blueprint.theme.popup.text' => 'nullable|string',
          'blueprint.theme.popup.ctaText' => 'nullable|string',
          'blueprint.theme.popup.ctaUrl' => 'nullable|string',
